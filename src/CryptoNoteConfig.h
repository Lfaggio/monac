...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xf5462;
...
const uint64_t DIFFICULTY_TARGET                             = 85; // seconds
...
const char     CRYPTONOTE_NAME[]                             = "lovecoin";
...
const int      P2P_DEFAULT_PORT                              = 191;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 291;
